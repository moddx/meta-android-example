...
class StubComputeUnit : public ComputeUnit {                // inject computeunit classname here..
public:
...
int main(int argc, char **argv) {
    ...
    cout << "Starting META::Backend instance for: StubComputeUnit" << endl;   // ..and inject here..

    ComputeUnit *cu = new StubComputeUnit();                                  // ..and here.
